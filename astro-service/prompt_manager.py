...
# 僅合盤/配對 prompt 需要的四軌道定義；單人 prompt 禁止注入以避免 token 污染
_TRACK_DEFINITIONS = """\
...
_PSYCH_TAG_ZH: dict[str, str] = {
    ...
    # North Node House (北交點落宮 — Tier 1 限定，此生進化的具體戰場)
    "North_Node_House_1":           "此生進化方向：把力量放回自己身上，停止在關係中迷失自我，建立真正屬於自己的身份認同",
    "North_Node_House_2":           "此生進化方向：建立穩固的自我價值與物質基礎，放下對他人資源或危機感的依賴",
    "North_Node_House_3":           "此生進化方向：學習在日常中真實溝通，放下高高在上的大道理，回到身邊的人與事",
    "North_Node_House_4":           "此生進化方向：打開內心，讓自己真正被家所承接，放下對外部成就的過度執念",
    "North_Node_House_5":           "此生進化方向：勇敢表達個人創造力與愛，放下對群體認可的依賴，活出自己的光",
    "North_Node_House_6":           "此生進化方向：紮根於日常工作與健康照顧，放下逃進靈性或夢境的習慣",
    "North_Node_House_7":           "此生進化方向：學習真正的合作與承諾，放下只照顧自己需求的慣性，在關係中成長",
    "North_Node_House_8":           "此生進化方向：擁抱深度的靈魂轉化與親密，放下對物質安穩或一成不變的執著",
    "North_Node_House_9":           "此生進化方向：拓展視野與信仰，放下對瑣碎細節的焦慮，找到更高的人生意義",
    "North_Node_House_10":          "此生進化方向：勇敢站上人生舞台承擔使命，放下縮在家庭或情感舒適圈的習慣",
    "North_Node_House_11":          "此生進化方向：走入群體、為理想服務，放下只追求個人戀愛或創造的小世界",
    "North_Node_House_12":          "此生進化方向：信任靈性與潛意識的智慧，放下對世俗完美秩序的過度控制",
    # ── Critical Degrees (0° & 29°) — extract_critical_degrees() ──────────
    "Blind_Impulse_SUN":            "太陽位於星座首度（0°），你的個人意志像一把剛出鞘的劍，本能強烈但容易衝動行事，對自我認同的渴望極為原始直接",
    "Blind_Impulse_MERCURY":        "水星位於星座首度（0°），你的思維與表達方式直覺且急切，有時說話前行動，溝通模式帶有強烈的原始衝動",
    "Blind_Impulse_VENUS":          "金星位於星座首度（0°），你在愛情與美的追求上本能而純粹，容易一見鍾情，對吸引力的反應極為直接且難以克制",
    "Blind_Impulse_MARS":           "火星位於星座首度（0°），你的行動力與欲望極為原始旺盛，具備充沛的創始能量，但衝動時容易忽略後果",
    "Blind_Impulse_MOON":           "月亮位於星座首度（0°），你的情緒反應本能而直接，安全感的需求極為強烈，情感模式帶有孩子般的純粹與脆弱",
    "Blind_Impulse_ASC":            "上升星座位於首度（0°），你給人的第一印象極具衝擊力，外在形象的展現極為原始且本能，無法掩飾真實的自我",
    "Karmic_Crisis_SUN":            "太陽位於星座末度（29°），你的個人意志正處於一個星座的終章，承載著深刻的業力課題，極度渴望完成某種使命後才能真正解脫",
    "Karmic_Crisis_MERCURY":        "水星位於星座末度（29°），你的思維與溝通模式帶有強烈的業力色彩，這一世的思考方式正在完成某種靈魂功課的最後收尾",
    "Karmic_Crisis_VENUS":          "金星位於星座末度（29°），你的愛情觀與關係模式帶有業力的迫切感，這一世的感情課題正在走向某種深刻的轉化與終結",
...
你現在是 DESTINY 系統的首席關係領航員。這不是普通的算命，而是一張「從被動宿命到主動創造」的關係導航圖，必須完美契合現代 App UI 的閱讀習慣，大量使用短句、條列式與 Icon。絕對不要寫長篇大論。
請根據以下三大命理體系的數據，為此人描繪出最適合他的對象、絕對要避開的雷區，以及理想的感情發展。
